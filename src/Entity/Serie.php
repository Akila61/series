...
class Serie
{
    ...
    #[Assert\NotBlank (message: 'Le mom ne peut être vide')]
    #[ORM\Column(length: 255)]
    private ?string $name = null;

    #[Assert\NotBlank(message: 'Le résumé ne peu être vide !')]
    #[Assert\Length(min:10, minMessage: 'Le résumé doit faire 10 caractéres minimun')]
